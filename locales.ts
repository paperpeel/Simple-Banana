...
export const translations = {
  en: {
    ...
    streamMode: "Stream / Async Mode",
    streamModeHelp: "Recommended for 4K generation. Uses streaming API to prevent proxy timeouts during long generation tasks.",
    resetUrl: "Reset URL",
    cancel: "Cancel",
    save: "Save Settings",
  ...
  zh: {
    ...
    streamMode: "流式/异步模式 (增强稳定性)",
    streamModeHelp: "推荐生成 4K 图片时开启。使用流式接口传输，可防止代理服务器因长时间等待而超时。",
    resetUrl: "重置 URL",
    cancel: "取消",
    save: "保存设置",
